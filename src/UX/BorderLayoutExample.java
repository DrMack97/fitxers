...
public class BorderLayoutExample {
    ...
    private static void initGUI() {
		...
		//configurar el layout (per defecte ja Ã©s BorderLayout).
		pane.setLayout(new BorderLayout());

		//crear array de referÃ¨ncies a JLabel
		...
		etiq[1].setOpaque(true); //per defecte, els components sÃ³n transparents.
